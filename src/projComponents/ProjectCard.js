...
const htmlWebProjects = [
    ...
    {img: "sweet-eats.jpg", name: "Sweet Eats Bakery", type: "1.1 User Interface I", visit: "https://codepen.io/vishalicious/pen/WVdwPN", view: "#", desc: "Sweet Eats required knowledge of CSS selectors, properties and inheritance to style the bakery's website. Written in CodePen, the website and code share a page.", stack: ["html", "css"]},
]

const jsDomProjects = [
    {img: "friends.jpg", name: "F-R-I-E-N-D-S List", type: "11.2 Client-Side Authentication", visit: "https://vish213-friends.netlify.app/", view: "https://github.com/vishalicious213/11.2-auth-friends", desc: "Made use of React-Router, protected routes, axios, AJAX, promises & authentication tokens to build CRUD app that lets user login & view friends list. Pages behind login are secured & require token to access. User can change details for each friend, add new friends & delete existing ones. Note: Current deploy needs local API server.", stack: ["js", "react", "axios"]},
    {img: "smurfs.jpg", name: "React Smurfs Village", type: "10.5 Sprint Challenge X: Advanced State Management", visit: "https://vish213-smurfs.netlify.app/", view: "https://github.com/vishalicious213/10.5-sprint-challenge-state-management-smurfs-v2", desc: "Managed global state with Context API & built Smurf village. Fetched data from local API with axios. Made form to update API data with new smurfs. Added ability to render male or female smurfs conditionally. Note: API will update locally, but not at Netlify.", stack: ["js", "react", "axios"]},
    ...
    {img: "react-wars.jpg", name: "React Wars", type: "6.5 Sprint Challenge VI: React", visit: "https://vish213-reactwars.netlify.com", view: "https://github.com/vishalicious213/6.5-Sprint-Challenge-React-Wars", desc: "Used axios to access the Star Wars API, then used React components, state and side effects to render information about Star Wars characters. Imported and rendered images separately. Styled using Styled Components.", stack: ["js", "react", "axios", "styled"]},
    {img: "nasa.jpg", name: "Astronomy Photo of the Day", type: "6.3 Component Side Effects", visit: "https://vish213-nasa.netlify.com/", view: "https://github.com/vishalicious213/6.3-nasa-photo-of-the-day", desc: "Utilized React's useEffect hook to run axios as a side effect & fetch 'Astronomy Photo of the Day' from NASA API. Built components to get data, render image & details. Held cosmic data on state and passed as props to components. Used ternary operator & state to toggle details on/off. Added a date picker to see new images and details.", stack: ["js", "react", "axios"]},
    {img: "instagram-clone.jpg", name: "Vishtagram", type: "6.2 Composing React Components & Passing Props", visit: "https://vish213-instagram.netlify.com/", view: "https://github.com/vishalicious213/6.2-React-Components-Insta-Clone/tree/vish-singh", desc: "Instagram clone using React. Rendered search bar section, posts with thumbnails, images, likes section and comments section. Made use of nested components, updated state with working 'likes' heart icon and drilled props down several levels.", stack: ["js", "react"]},
