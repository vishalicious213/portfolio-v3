...
const jsDomProjects = [
    ...
    {img: "my-emojis.jpg", name: "Express Yourself Through Emojis", type: "Personal Project", visit: "https://vish213-express-yourself.netlify.app/", view: "https://github.com/vishalicious213/my-emojis", desc: "Pick emojis from a list to show them onscreen. Select each emoji's size. The size button is highlighted and remains active until a new size is chosen. Remove emojis from the beginning or end of your list.", stack: ["js", "dom"]},
