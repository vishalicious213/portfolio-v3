...
const jsDomProjects = [
    {img: "wildfires.jpg", name: "Iconic Web Studios v1", type: "Professional Project", visit: "https://vish213-iconic.netlify.app/", view: "https://github.com/vishalicious213/iconic-v2", desc: "Iconic Web Studios is my web development company. Its where I put into practice the programming concepts I've learned in service to other companies and individuals. I've assembled a small team of developers and designers to help manage the workload and provide companies with an online presence. Its focus is on using responsive, mobile-first design and SEO best practices to grow small businesses and help them succeed in their markets. This was my hasty v1 of the website.", stack: ["js", "react", "next", "netlify"]},
    {img: "wildfires.jpg", name: "Wildfire Tracker", type: "Personal Project", visit: "https://vish213-wildfire.netlify.app/", view: "https://github.com/vishalicious213/wildfires", desc: "React Hooks app. Displays wildfires around the globe. Uses NASA Open API for wildfire data, Google Maps API for map generation, Google-Map-React to render data geolocationally & Iconify to provide fire icons.", stack: ["js", "react", "nasa", "g-maps", "map", "iconify"]},
                            ...
                            <Tech className={project.stack}>{
                                project.stack.map(item => {
                                    switch (item) {
                                        ...
                                        case 'next' : return (<Lib title='Next.js' className="iconify" key='next-js' data-icon="logos:nextjs-icon" data-inline="false"></Lib>);
