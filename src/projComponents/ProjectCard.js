...
const featuredProjects = [
    ...
    {img: "nasa.jpg", name: "Astronomy Photo of the Day", type: "Component Side Effects", visit: "https://vish213-nasa.netlify.com/", view: "https://github.com/vishalicious213/6.3-nasa-photo-of-the-day", desc: "Utilized the useEffect hook to cause axios to run as a side effect to fetch the 'Astronomy Photo of the Day' from the NASA API. Built components with React to get data, render image, render image details and hide/show details. Used a ternary operator and state to execute details toggle. Held cosmic data on state and passed as props to components.", stack: ["js", "react", "axios"]},
...
const jsDomProjects = [
    {img: "10-recipes.jpg", name: "10 Recipes", type: "React Project [Dev Ed]", visit: "https://vish213-10recipes.netlify.com/", view: "https://github.com/vishalicious213/recipes", desc: "React Hooks application with a working searchbar that queries the Edamam Recipe Search API and returns 10 recipes with a given keyword. Used async/await to fetch data from API queries, useState and useEffect for stateful functional components and passed data from parent to child via props. Recipe titles and images link to Edamam recipe pages.", stack: ["js", "react"]},
    {img: "rick-and-morty.jpg", name: "Rick and Morty Fansite", type: "Sprint Challenge VI: Single Page Applications", visit: "https://vish213-rick-and-morty.netlify.com/", view: "https://github.com/vishalicious213/7.5-Sprint-Challenge-Single-Page-Apps-v2", desc: "Got data from Rick and Morty API using axios and rendered character data. Used React Router to build a single-page application (SPA) with Routes and Links to components. Used Styled Components to style site and built a search form that filters through characters to find the one(s) sought.", stack: ["js", "react", "reactr", "axios", "styled"]},
