...
const jsDomProjects = [
    {img: "profile-generator.jpg", name: "Profile Generator", type: "Personal Project", visit: "https://vish213-profile-generator.netlify.app/", view: "https://github.com/vishalicious213/profile-generator", desc: "Build a short online profile. Add your name, fun facts about yourself, your LinkedIn profile and a profile pictore. Change the page theme via drop-downs that change the font, background color, text color, light or dark mode and element corners.", stack: ["js", "dom", "css"]},
    ...
    {img: "my-emojis.jpg", name: "Express Yourself Via Emojis", type: "Personal Project", visit: "https://vish213-express-yourself.netlify.app/", view: "https://github.com/vishalicious213/my-emojis", desc: "Pick emojis from a list to show them onscreen. Select each emoji's size. The size button is highlighted and remains active until a new size is chosen. Remove emojis from the beginning or end of your list.", stack: ["js", "dom"]},
    ...
    {img: "unit-converter.jpg", name: "Unit Converter", type: "Personal Project", visit: "https://vish213-unit-converter.netlify.app/", view: "https://github.com/vishalicious213/unit-converter", desc: "Converts length (meters/feet), volume (liters/gallons) and mass (kilograms/pounds) from metric to imperial units, and vice versa.", stack: ["js", "dom"]},
    ...
    {img: "pw-generator.jpg", name: "Random Password Generator", type: "Personal Project", visit: "https://vish213-pwgen.netlify.app/", view: "https://github.com/vishalicious213/password-generator", desc: "Renders two random passwords for visitor to copy. Visitor can choose to use letters, numbers & symbols and can select password length.", stack: ["js", "dom"]},
