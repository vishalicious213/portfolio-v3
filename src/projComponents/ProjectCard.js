...
const featuredProjects = [
    ...
    {img: "basic-rpg.jpg", name: "Basic RPG", type: "Scrimba M7 Project", visit: "https://vish213-basic-rpg.netlify.app/", view: "https://github.com/vishalicious213/basic-rpg", desc: "Basic RPG combat system. Play as a Wizard and face off against a trio of foes in a fight to the death. Conjured with object destructuring, Array constructors & mapping, chaining methods, 'this' & constructor functions, Object.assign, classes and more.", stack: ["js", "dom", "css"]},
...
const htmlWebProjects = [
    {img: "tw-manage.jpg", name: "Manage Landing page", type: "Solo Project", visit: "https://vish213-tw-manage.netlify.app/", view: "https://github.com/vishalicious213/tw-splashboard", desc: "Landing page for Manage reporting software. Built with Tailwind CSS.", stack: ["js", "html", "css"]},
    ...
    {img: "deathfest.jpg", name: "Deathfest Splash Page", type: "Personal Project", visit: "https://vish213-deathfest2024.netlify.app/", view: "https://github.com/vishalicious213/deathfest", desc: "Responsive sign-up page for the 2024 Maryland Deathfest. Uses viewport units, text transformations, Flexbox order, media queries, modifier classes and box-sizing to render mobile and larger screen views.", stack: ["html", "css"]},
    {img: "splash-page.jpg", name: "Product Splash Page", type: "Scrimba M6 Project", visit: "https://vish213-scrimbafy.netlify.app/", view: "https://github.com/vishalicious213/splash-page", desc: "Responsive splash page for 'Scrimbafy.me'. Uses viewport units, text transformations, Flexbox order, media queries, modifier classes and box-sizing to render mobile and larger screen views.", stack: ["html", "css"]},
    {img: "flexbox-gallery.jpg", name: "Flexbox Gallery", type: "Scrimba M6 Project", visit: "https://vish213-flexbox-gallery.netlify.app/", view: "https://github.com/vishalicious213/flexbox-gallery", desc: "Responsive gallery focusing on CSS Flexbox. Makes use of flex-wrap, gap, flex, flex-basis, flex-grow and object-fit to create an image gallery with a staggered, subway-tile effect.", stack: ["html", "css"]},
    ...
    {img: "godflesh.jpg", name: "Godflesh Tribute Page", type: "Personal Project", visit: "https://vish213-godflesh.netlify.app/", view: "https://github.com/vishalicious213/godflesh", desc: "Responsive, single-page website focusing on semantic HTML and CSS. Delves into margin properties, hover & active states, container elements, compound selectors, modifier classes.", stack: ["html", "css"]},
...
const reactProjects = [
    {img: "notes-app.jpg", name: "Notes App", type: "Scrimba M11 Project", visit: "https://vish213-notes-app.netlify.app/", view: "https://github.com/vishalicious213/notes-app-v2", desc: "Markdown editor. Focus is on passing props, managing state, useEffect for loading initial state from Firebase & debouncing Firebase database writes by 500ms.", stack: ["js", "react", "firebase"]},
    {img: "meme-generator.jpg", name: "Meme Generator", type: "Solo Project", visit: "https://vish213-meme-generator.netlify.app/", view: "https://github.com/vishalicious213/meme-generator", desc: "Get random meme image from imgflip API and add text to it. Focus is on forms with controlled inputs, the useState and useEffect hooks and using fetch API to talk to outside data sources.", stack: ["js", "react"]},
    {img: "show-journal.jpg", name: "Show Journal", type: "Solo Project", visit: "https://vish213-show-journal.netlify.app/", view: "https://github.com/vishalicious213/show-journal", desc: "Interactive show journal built with React Hooks. Focus on mapping through data, passing props and rendering components. Responsive design. Articles can be clicked to open in modal. Modal includes scrollable image gallery.", stack: ["js", "react"]},
    {img: "experiences.jpg", name: "AirBnB Experiences Clone", type: "Scimba M11 Project", visit: "https://vish213-experiences.netlify.app/", view: "https://github.com/vishalicious213/experiences", desc: "This AirBnB Experiences clone built using React Hooks maps through array of activities and passes data to a render component via props to show experiences that might interest the viewer.", stack: ["js", "react"]},
    {img: "digital-biz-card.jpg", name: "Digital Business Card", type: "Scimba M11 Project", visit: "https://vish213-bizcard.netlify.app/", view: "https://github.com/vishalicious213/digital-biz-card", desc: "Used React Hooks with a focus on JSX and module imports & exports to render a business card based on a Figma design. Each section renders from an individual component.", stack: ["js", "react"]},
