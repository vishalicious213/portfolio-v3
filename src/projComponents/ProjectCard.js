...
const htmlWebProjects = [
    ...
    {img: "fcc-3.jpg", name: "fCC Product Landing Page", type: "freeCodeCamp Responsive Web Design Project 3", visit: "https://codepen.io/vishalicious/full/pobRavL", view: "https://codepen.io/vishalicious/pen/pobRavL", desc: "Product landing page included responsive image, buttons in a navigation bar, an embedded video & a simple form to collect email addresses. Navbar is attached to top of screen. Used flexbox & media queries for responsiveness.", stack: ["html", "css", "codepen"]},
