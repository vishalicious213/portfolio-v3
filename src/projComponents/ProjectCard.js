...
const featuredProjects = [
    {img: "todo.jpg", name: "To-Do List", type: "Class Components", visit: "https://vish213-todo.netlify.com/", view: "https://github.com/vishalicious213/9.1-react-todo-v2", desc: "Yes, a to-do list. Its cliche, but a great way to practice working with state & forms. Built stateful class component. Displays list of tasks, an input field, submit button & clear button. Child components use helper functions from parent to update state when tasks are added or completed.", stack: ["js", "react"]},
