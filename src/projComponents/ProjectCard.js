...
const featuredProjects = [
    ...
    {img: "pw-generator.jpg", name: "Random Password Generator", type: "Scrimba Project", visit: "https://vish213-pwgen.netlify.app/", view: "https://github.com/vishalicious213/password-generator", desc: "Renders two random passwords for visitor to copy. Visitor can choose to use letters, numbers & symbols and can select password length.", stack: ["js", "dom"]},
]
...
const htmlWebProjects = [
    ...
    {img: "coworking.jpg", name: "Co-Working Spaces", type: "Scrimba Project", visit: "https://vish213-coworking.netlify.app/", view: "https://github.com/vishalicious213/coworking-site", desc: "Responsive, multi-page website built with semantic HTML, CSS and JavaScript for the menu. CSS use focused on layout and positioning elements via Flexbox and the 'position' property.", stack: ["js", "html", "css"]},
    {img: "nft.jpg", name: "NFT Mania", type: "Scrimba Project", visit: "https://vish213-nft.netlify.app/", view: "https://github.com/vishalicious213/nft-site", desc: "Responsive, single-page website focusing on semantic HTML and CSS.", stack: ["html", "css"]},
    {img: "hometown.jpg", name: "My Hometown", type: "Scrimba Project", visit: "https://vish213-hometown.netlify.app/", view: "https://github.com/vishalicious213/hometown", desc: "Multi-page website that shows information about 3 cities and a homepage. Makes use of semantic HTML and is responsive on large and small screens.", stack: ["html", "css"]},
    {img: "birthday-gift.jpg", name: "Birthday Gift", type: "Scrimba Project", visit: "https://vish213-birthday.netlify.app/", view: "https://github.com/vishalicious213/birthday-gift", desc: "Birthday tribute page that features hover effects that change a picture when its hovered over and a linear gradient background.", stack: ["html", "css"]},
    {img: "space-exploration.jpg", name: "Space Exploration", type: "Scrimba Project", visit: "https://vish213-space.netlify.app/", view: "https://github.com/vishalicious213/space-exploration", desc: "Website for space exploration company. Used background properties, text-shadow, Flexbox, outline, text-decoration, text-decoration-color and other CSS techniques to style page.", stack: ["html", "css"]},
    {img: "biz-card.jpg", name: "Digital Business Card", type: "Scrimba Project", visit: "https://vish213-biz-card.netlify.app/", view: "https://github.com/vishalicious213/biz-card", desc: "Online business card that shows my name, title, picture, city & state, email address and links to my LinkedIn profile, portfolio, GitHub page and coding blog. The link icons work.", stack: ["html", "css"]},
...
const jsDomProjects = [
    {img: "jimmys-diner.jpg", name: "Jimmy's Diner", type: "Solo Project", visit: "https://vish213-jimmys-diner.netlify.app/", view: "https://github.com/vishalicious213/restaurant-ordering-app", desc: "Jimmy's Diner serves the best burgers and pizzas in town. Their menu website was prepared using the finest JavaScript including arrays, getElementById() and a sampler platter teeming with JavaScript methods and CSS goodies.", stack: ["js", "dom", "css"]},
    ...
    {img: "unit-converter.jpg", name: "Unit Converter", type: "Scrimba Project", visit: "https://vish213-unit-converter.netlify.app/", view: "https://github.com/vishalicious213/unit-converter", desc: "Converts length (meters/feet), volume (liters/gallons) and mass (kilograms/pounds) from metric to imperial units, and vice versa.", stack: ["js", "dom"]},
    ...
    {img: "basketball-scoreboard.jpg", name: "Basketball Scoreboard", type: "Scrimba Project", visit: "https://vish213-basket-score.netlify.app/", view: "https://github.com/vishalicious213/basketball-scoreboard", desc: "Basketball scoreboard. Three buttons per team to increment score by 1, 2 or 3 points. Made use of getElementById to wire button-connected functions to HTML elements.", stack: ["js", "dom"]},
    {img: "blackjack.jpg", name: "Blackjack", type: "Scrimba Project", visit: "https://vish213-blackjack.netlify.app/", view: "https://github.com/vishalicious213/blackjack", desc: "Single-player blackjack game. Used JavaScript to manipulate DOM elements to update game state. Draw a hand, get a new card, reset game.", stack: ["js", "dom"]},
    {img: "rep-counter.jpg", name: "Repitition/Lap Counter", type: "Scrimba Project", visit: "https://vish213-reps.netlify.app/", view: "https://github.com/vishalicious213/rep-counter", desc: "Track the number of reps in a set when working out or the number of minutes in a lap when running/walking. Used getElementById to connect button outputs to HTML elements.", stack: ["js", "dom"]},
