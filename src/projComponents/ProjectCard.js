...
const jsDomProjects = [
    {img: "iconic-v2.gif", name: "Iconic Web Studios v2", type: "Professional Project", visit: "https://iconicweb.dev/", view: "https://github.com/vishalicious213/iconic-v3", desc: "This is v2 of the website for Iconic Web Studios, my web development company. Visually, I went in a completely different direction from v1. I still used React and Next.js to build it, but added on Google Maps and Netlify Forms. This version is currently live, on the domain www.iconicweb.dev.", stack: ["js", "react", "next", "g-maps", "netlify"]},
    {img: "iconic-v1.gif", name: "Iconic Web Studios v1", type: "Professional Project", visit: "https://vish213-iconic.netlify.app/", view: "https://github.com/vishalicious213/iconic-v2", desc: "Iconic Web Studios is my web development company. Its where I put into practice the programming concepts I've learned in service to other companies and individuals. I've assembled a small team of developers and designers to help manage the workload and provide companies with an online presence. Its focus is on using responsive, mobile-first design and SEO best practices to grow small businesses and help them succeed in their markets. This was my hasty v1 of the website.", stack: ["js", "react", "next"]},
    {img: "wildfires.jpg", name: "Wildfire Tracker", type: "Personal Project", visit: "https://vish213-wildfire.netlify.app/", view: "https://github.com/vishalicious213/wildfires", desc: "React Hooks app. Displays wildfires around the globe. Uses NASA Open API for wildfire data, Google Maps API for map generation, Google-Map-React to render data geolocationally & Iconify to provide fire icons.", stack: ["js", "react", "nasa", "g-maps", "map", "iconify"]},
